...
size_t bitmap_scan_next (const struct bitmap *b, size_t start, size_t cnt, bool value) ;
/* Add by JongHyun */
...
size_t bitmap_scan_next_and_flip (struct bitmap *b, size_t start, size_t cnt, bool value);
